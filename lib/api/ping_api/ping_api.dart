...
class PingApi {
  // 扫描一个ip区间
  static Future<List<PingResult>> scanIpWithRange(String start, String end, {timeout=30000}) async {
    ...
    // 等待所有扫描完成
    await Future.wait(futureList).timeout(Duration(milliseconds: timeout));
    if (kDebugMode) {
